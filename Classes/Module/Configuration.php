 ...
 *
 */
class Configuration extends \TYPO3\CMS\Backend\Module\BaseScriptClass {
	...
	protected function moduleContent() {
		$configArray[1] = array(
			...
			'from_email' => array('string', DirectMailUtility::fName('from_email'), $GLOBALS['LANG']->getLL('from_email.description').'<br />'.$GLOBALS['LANG']->getLL('from_email.details')),
			'from_name' => array('string', DirectMailUtility::fName('from_name'), $GLOBALS['LANG']->getLL('from_name.description').'<br />'.$GLOBALS['LANG']->getLL('from_name.details')),
			'replyto_email' => array('string', DirectMailUtility::fName('replyto_email'), $GLOBALS['LANG']->getLL('replyto_email.description').'<br />'.$GLOBALS['LANG']->getLL('replyto_email.details')),
			'replyto_name' => array('string', DirectMailUtility::fName('replyto_name'), $GLOBALS['LANG']->getLL('replyto_name.description').'<br />'.$GLOBALS['LANG']->getLL('replyto_name.details')),
			'return_path' => array('string', DirectMailUtility::fName('return_path'), $GLOBALS['LANG']->getLL('return_path.description').'<br />'.$GLOBALS['LANG']->getLL('return_path.details')),
			'organisation' => array('string', DirectMailUtility::fName('organisation'), $GLOBALS['LANG']->getLL('organisation.description').'<br />'.$GLOBALS['LANG']->getLL('organisation.details')),
			'priority' => array('select', DirectMailUtility::fName('priority'), $GLOBALS['LANG']->getLL('priority.description').'<br />'.$GLOBALS['LANG']->getLL('priority.details'), array(3 => $GLOBALS['LANG']->getLL('configure_priority_normal'), 1 => $GLOBALS['LANG']->getLL('configure_priority_high'), 5 => $GLOBALS['LANG']->getLL('configure_priority_low'))),
		);
		$configArray[2] = array(
			'box-2' => $GLOBALS['LANG']->getLL('configure_default_content'),
			'sendOptions' => array('select', DirectMailUtility::fName('sendOptions'), $GLOBALS['LANG']->getLL('sendOptions.description').'<br />'.$GLOBALS['LANG']->getLL('sendOptions.details'), array(3 => $GLOBALS['LANG']->getLL('configure_plain_and_html') ,1 => $GLOBALS['LANG']->getLL('configure_plain_only') ,2 => $GLOBALS['LANG']->getLL('configure_html_only'))),
			'includeMedia' => array('check', DirectMailUtility::fName('includeMedia'), $GLOBALS['LANG']->getLL('includeMedia.description').'<br />'.$GLOBALS['LANG']->getLL('includeMedia.details')),
			'flowedFormat' => array('check', DirectMailUtility::fName('flowedFormat'), $GLOBALS['LANG']->getLL('flowedFormat.description').'<br />'.$GLOBALS['LANG']->getLL('flowedFormat.details')),
		);
		$configArray[3] = array(
			'box-3' => $GLOBALS['LANG']->getLL('configure_default_fetching'),
			'HTMLParams' => array('short', DirectMailUtility::fName('HTMLParams'), $GLOBALS['LANG']->getLL('configure_HTMLParams_description').'<br />'.$GLOBALS['LANG']->getLL('configure_HTMLParams_details')),
			'plainParams' => array('short', DirectMailUtility::fName('plainParams'), $GLOBALS['LANG']->getLL('configure_plainParams_description').'<br />'.$GLOBALS['LANG']->getLL('configure_plainParams_details')),
			'use_domain' => array('select', DirectMailUtility::fName('use_domain'), $GLOBALS['LANG']->getLL('use_domain.description').'<br />'.$GLOBALS['LANG']->getLL('use_domain.details'), array(0 => '')),
		);
		$configArray[4] = array(
		...
		$configArray[5] = array(
			...
			'use_rdct' => array('check', DirectMailUtility::fName('use_rdct'), $GLOBALS['LANG']->getLL('use_rdct.description').'<br />'.$GLOBALS['LANG']->getLL('use_rdct.details').'<br />'.$GLOBALS['LANG']->getLL('configure_options_links_rdct')),
			'long_link_mode' => array('check', DirectMailUtility::fName('long_link_mode'), $GLOBALS['LANG']->getLL('long_link_mode.description')),
			...
			'authcode_fieldList' => array('short', DirectMailUtility::fName('authcode_fieldList'), $GLOBALS['LANG']->getLL('authcode_fieldList.description')),
		);
		$configArray[6] = array(
	...
	function updatePageTS()	{
		if ($GLOBALS["BE_USER"]->doesUserHaveAccess(BackendUtility::getRecord( 'pages', $this->id), 2)) {
			$pageTS = GeneralUtility::_GP('pageTS');
			if (is_array($pageTS)) {
				DirectMailUtility::updatePagesTSconfig($this->id,$pageTS,$this->TSconfPrefix);
